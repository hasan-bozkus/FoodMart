...
{
    public class MGFeatureRepository : GenericRepository<Feature>, IFeatureDal
    {
        public MGFeatureRepository(IDatabaseSettingsKey databaseSettingsKey, FoodMartContext context) : base(databaseSettingsKey, context)
        {
        }
    }
}
