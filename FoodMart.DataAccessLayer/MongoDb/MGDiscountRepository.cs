...
{
    public class MGDiscountRepository : GenericRepository<Discount>, IDiscountDal
    {
        public MGDiscountRepository(IDatabaseSettingsKey databaseSettingsKey, FoodMartContext context) : base(databaseSettingsKey, context)
        {
        }
    }
}
