...
{
    public class MGCategoryRepository : GenericRepository<Category>, ICategoryDal
    {
        public MGCategoryRepository(IDatabaseSettingsKey databaseSettingsKey, FoodMartContext context) : base(databaseSettingsKey, context)
        {
        }
    }
}
