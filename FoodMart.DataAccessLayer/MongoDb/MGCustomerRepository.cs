...
{
    public class MGCustomerRepository : GenericRepository<Customer>, ICustomerDal
    {
        public MGCustomerRepository(IDatabaseSettingsKey databaseSettingsKey, FoodMartContext context) : base(databaseSettingsKey, context)
        {
        }
    }
}
